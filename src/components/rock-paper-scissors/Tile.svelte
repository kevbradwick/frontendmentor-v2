<script>
  export let type = "rock";

  /** @type RockPaperScissors.TileConfig */
  const tileConfig = {
    rock: {
      outerShadow: "#9f1433",
      fillFrom: "hsl(349, 71%, 52%)",
      fillTo: "hsl(349, 70%, 56%)",
      icon: "rock"
    },
    paper: {
      outerShadow: "#2845c5",
      fillFrom: "hsl(230, 89%, 62%)",
      fillTo: "hsl(230, 89%, 65%)",
      icon: "paper"
    },
    scissors: {
      outerShadow: "#c86a13",
      fillFrom: "hsl(39, 89%, 49%)",
      fillTo: "hsl(40, 84%, 53%)",
      icon: "scissors"
    },
    lizard: {
      outerShadow: "#5f37aa",
      fillFrom: "hsl(261, 73%, 60%)",
      fillTo: "hsl(261, 72%, 63%)",
      icon: "lizard"
    },
    spock: {
      outerShadow: "#2b8ead",
      fillFrom: "hsl(189, 59%, 53%)",
      fillTo: "hsl(189, 58%, 57%)",
      icon: "spock"
    }
  };

  // defaults to rock to avoid errors
  const _config = tileConfig[type] || tileConfig.rock;
</script>
